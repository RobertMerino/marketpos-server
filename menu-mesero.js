// ============================================
// TITO BURGER - MENÚ MESERO PREMIUM
// ============================================
...
function renderCategories() {
    const container = document.getElementById('categoriesContainer') || document.getElementById('categoryScroll');
    if (!container) return;
...
function renderCartItems() {
    ...
    if (cart.length === 0) {
        itemsEl.innerHTML = '<p style="text-align:center;color:#999;padding:20px;">No hay productos</p>';
        return;
    }
    ...
    itemsEl.innerHTML = cart.map((i, idx) => `
        <div class="cart-item-premium">
            <div>
                ...
                <br><small>$${i.precio.toFixed(2)} c/u</small>
            </div>
...
async function confirmOrder() {
    ...
    cart = []; updateCartFloat(); updateCartCount(); closeCart();
